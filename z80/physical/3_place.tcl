...
#CTS
#eval_legacy { setCTSMode -engine ccopt }
#eval_legacy { set_ccopt_property use_inverters auto }
#eval_legacy { setCCOptMode -cts_opt_type full }

eval_legacy { create_ccopt_clock_tree_spec -file physical/ccopt.spec }
eval_legacy { source physical/ccopt.spec }
ccopt_design

eval_legacy { report_ccopt_clock_trees -filename clock_trees.rpt }
...
# Routing
## old
## route_design -placement_check -global_detail

## new, using nano-route: https://slideplayer.com/slide/12205479/
