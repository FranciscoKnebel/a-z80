...
########################################################
source synthesis/a-z80.genus_init.tcl
read_metric -id current synthesis/a-z80.metrics.json

source synthesis/a-z80.g
...
if {$_slk_ != "90.9"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: 90.9,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
# tns
...
if {$_cell_area_ != "64747"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 64747,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "37619"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 37619,  current net area: $_net_area_"
}
unset _net_area_
